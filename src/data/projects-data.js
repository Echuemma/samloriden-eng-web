...
export const projects = [
    ...
    },
    {
        ...
        area: "Assessment of 25,000 sq ft complex",
        image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=400&h=300&fit=crop&crop=building",
        gallery: [
        ...
        features: [
            ...
            "Retrofitting design recommendations",
    ...
    },
    {
        ...
        area: "Site investigation of 50 acres",
        image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=400&h=300&fit=crop&crop=building",
        gallery: [
            "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=800&h=600&fit=crop&crop=building",
            "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&h=600&fit=crop&crop=building",
            "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800&h=600&fit=crop&crop=building"
        ],
        features: [
            "Comprehensive soil boring program",
            "Laboratory geotechnical testing",
            "Foundation design optimization",
            "Slope stability analysis",
            "Settlement prediction modeling",
    ...
    },
    {
        ...
        features: [
            "Extended bridge span construction",
    ...
    },
    {
        ...
        status: "Completed",
        category: "Consultation",
        client: "Regional Transportation Planning Board",
        area: "Study area covering 200 hectares",
        image: "https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=400&h=300&fit=crop&crop=transport",
        gallery: [
            "https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=800&h=600&fit=crop&crop=transport",
            "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800&h=600&fit=crop&crop=building",
            "https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=800&h=600&fit=crop&crop=building"
        ],
        features: [
            "Multi-modal integration analysis",
            "Traffic flow optimization studies",
    ...
    },
    {
        ...
        location: "102.2 Sylvet, Bangladesh",
        date: "12-2024 / 4-2025",
        status: "Design Phase",
        category: "Commercial",
    ...
    },
    {
        ...
        status: "In Progress",
        category: "Consultation",
        client: "Green Building Solutions Inc",
        area: "Assessment of 75,000 sq ft facility",
        image: "https://images.unsplash.com/photo-1460472178825-e5240623afd5?w=400&h=300&fit=crop&crop=building",
        gallery: [
            "https://images.unsplash.com/photo-1460472178825-e5240623afd5?w=800&h=600&fit=crop&crop=building",
            "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&h=600&fit=crop&crop=building",
            "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=800&h=600&fit=crop&crop=building"
        ],
        features: [
            "Comprehensive energy performance audit",
...
export const getRelatedProjects = (currentId, limit = 3) => {
    return projects.filter(project => project.id !== parseInt(currentId)).slice(0, limit);
};
...
export const getConsultationProjects = () => {
    return projects.filter(project => project.category === 'Consultation');
};

export const getConstructionProjects = () => {
    return projects.filter(project => project.category !== 'Consultation');
};
