        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600">Loading SAMLORIDEN engineering projects...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50">
            <nav className="flex items-center px-12 py-8 mt-12">
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-black font-semibold text-sm ml-1">Engineering Projects</span>
                </div>
            </nav>
                        ...
                        <div className="space-y-6 lg:space-y-10 pt-1 lg:pt-25 item-center">
                            <div>
                                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-none tracking-tight">
                                    <div className="text-black">Our Engineering Projects.</div>
                                    <div className="text-gray-300 mt-2">Excellence Delivered.</div>
                                </h1>
                            </div>

                            <p className="text-gray-600 text-base lg:text-lg leading-relaxed max-w-md">
                                At SAMLORIDEN ENGINEERING AND CONSULTANCY LTD, every project demonstrates 
                                our integrated approach to civil engineering and real estate development. 
                                From structural design to property management, our portfolio reflects 
                                our commitment to technical excellence and sustainable solutions across Nigeria.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4 lg:space-y-6">
                            <div className="relative w-full h-64 lg:h-80 bg-gray-200 shadow-lg overflow-hidden" style={{
                                ...
                                <img
                                    ...
                                    alt="SAMLORIDEN Engineering construction project civil engineering Nigeria"
                            ...
                            <div className="grid grid-cols-2 gap-4 lg:gap-6">
                                <div className="relative w-full h-40 lg:h-48 bg-gray-200 shadow-md overflow-hidden"
                                    ...
                                    <img
                                        ...
                                        alt="Structural engineering design SAMLORIDEN building projects"
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                                ...
                                <div className="relative w-full h-40 lg:h-48 bg-gray-200 shadow-md overflow-hidden" style={{
                                    ...
                                    <img
                                        ...
                                        alt="SAMLORIDEN construction management quality control Nigeria"
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
                    <div className="space-y-4 lg:space-y-6" data-aos="fade-right">
                        ...
                        <h2 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
                            Discover Our Civil Engineering & Real Estate Projects
                        </h2>
                    </div>

                    <div className="text-gray-600 text-base lg:text-lg leading-relaxed" data-aos="fade-left" data-aos-delay="200">
                        Every project we complete demonstrates our commitment to engineering excellence, sustainable design, and client satisfaction. At{' '}
                        <span className="text-gray-900 font-semibold">SAMLORIDEN ENGINEERING AND CONSULTANCY LTD</span>, we transform complex engineering challenges into successful built environments — whether structural design, infrastructure development, or integrated real estate solutions across Nigeria.
                    </div>
                </div>
            </section>
                    ...
                    {projectsData.map((project) => (
                        <div key={project.id} className="rounded-lg overflow-hidden group duration-300 flex flex-col h-full" data-aos="fade-up">
                            <div className="relative h-64 overflow-hidden">
                                <img
                                    src={project.image}
                                    alt={`${project.title} SAMLORIDEN Engineering project Nigeria`}
