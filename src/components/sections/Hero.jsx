        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full items-center">
          <div className="lg:col-span-2 space-y-8">
            <div className="transform transition-all duration-700">
              <h1 className="text-5xl lg:text-6xl text-on-dark font-bold text-white leading-tight mb-6" data-aos="fade-up">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-6 max-w-sm ml-auto transform transition-all duration-700 delay-300" data-aos="fade-left">
              <div className="aspect-[4/3] bg-gray-200 rounded-2xl overflow-hidden mb-4">
                <img
